    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_data', models.JSONField(blank=True, help_text="Data format: {'vendor_id':{'subtotal':'tax_data'}}]", null=True)),
                ('total_tax', models.FloatField()),
                ('payment_method', models.CharField(max_length=25)),
                ('status', models.CharField(choices=[('New', 'New'), ('Received', 'Received'), ('Completed', 'Completed'), ('Cancelled', 'Cancelled')], default='New', max_length=15)),
